    ...
    <section className="min-h-[90vh] grid grid-cols-1 xl:grid-cols-8">
      ...
      <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16">
        <div className="flex flex-col gap-8">
          <h1 className="text-5xl xl:text-7xl font-bold xl:leading-[7.5rem] leading-[4.5rem]">
            We Design Impactful Digital{" "}
            <span className="text-primary py-2 px-6 border-8 border-primary relative inline-block ">
              Products
              <RiCheckboxBlankCircleFill className="text-base absolute -left-5 -top-5 text-white p-2 bg-primary box-content rounded-full" />
              <RiCheckboxBlankCircleFill className="text-base absolute -right-5 -top-5 text-white p-2 bg-primary box-content rounded-full" />
              <RiCheckboxBlankCircleFill className="text-base absolute -right-5 -bottom-5 text-white p-2 bg-primary box-content rounded-full" />
              <RiCheckboxBlankCircleFill className="text-base absolute -left-5 -bottom-5 text-white p-2 bg-primary box-content rounded-full" />
            </span>{" "}
          </h1>
      ...
      <div className="md:col-span-3 flex items-center justify-center relative">
        ...
        <img
          src="adobe.png"
          className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-l-8 border-gray-600 absolute top-[10%] left-[20%] xl:top-[2%] xl:left-[10%] "
        />
        <img
          src="sketch.png"
          className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full absolute -bottom-[12%] md:bottom-[5%] left-[15%] xl:left-[3%] -rotate-12 "
        />
      </div>
    </section>
  );
