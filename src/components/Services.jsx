...
const Services = () => {
  return (
    <div className="grid grid-cols-1 gap-8 md:gap-20 md:grid-cols-2 xl:p-20 p-8 md:p-12">
      <div className="flex flex-col gap-4">
        ...
        <form className="w-full">
          <div className="relative">
            ...
            <button
              type="submit"
              className="absolute right-2 top-1/2 font-semibold py-2 px-6 bg-primary text-white rounded-xl -translate-y-1/2"
            >
              Subscribe
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-2">
          <RiMacFill className="text-4xl p-2 bg-secondary text-primary box-content rounded-xl" />
          <h3 className="text-[20px] font-bold">Web Design</h3>
          <p className="text-gray-500">
            Sometimes features require a short description
          </p>
        </div>
